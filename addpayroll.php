		...
		<div>
			<div class="container">
    			<section id="content">
            		...
            		<div>
                		<input type="text" name="eID" placeholder="Employee ID" required><br>
            		</div>
            		<div>
                		<input type="text" name="eName" placeholder="Employee Name" required>
            		</div>
            		<div>
                		<input type="text" name="rateperhour" placeholder=" Rate per hour"required>
            		</div>
            		<div>
                		<input type="text" name="hourperday" placeholder="Hour Per Day" required>
            		</div>
            		<div>
                		<input type="text" name="numberofdayswork" placeholder="Number of Days Work" required>
            		</div>
            		<div>
...
$numberofdayswork = $_POST['numberofdayswork'];
@$grossSalary=$rateperhour*$hourperday*$numberofdayswork;
@$tax = ($grossSalary *0.15);
@$philhealth = ($grossSalary *0.05);
@$sss = ($grossSalary *0.02);
@$totaldeduct=($tax+$philhealth+$sss);
@$netsalary = $grossSalary - $totaldeduct;
if($eID == "" or $eName == "" or $rateperhour == "" or $hourperday == "" or $numberofdayswork == "")
{
	echo "<center>Please fill out all fields<center>";
}
else
{
if(mysqli_query($con, "insert into payroll( eID, eName, rateperhour, hourperday, numberofdayswork, grossSalary,tax,philhealth,sss,totaldeduct,netsalary) values('$eID','$eName','$rateperhour','$hourperday','$numberofdayswork','$grossSalary','$tax','$philhealth' ,'$sss' ,'$totaldeduct','$netsalary')"))
{
	echo "<script>alert('record saved');</script>";
	echo "<script>window.location.href='addpayroll.php'</script>";
}
else
{
	echo "saving failed";
