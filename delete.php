...
@$eID = $_REQUEST['id'];
#@$db_eName = $_POST['eName'];
$q_delete=mysqli_query($con, "SELECT * FROM employee WHERE eID='$eID'");
		
while ($row_delete = mysqli_fetch_assoc($q_delete)) {
	$eID = $row_delete['eID'];

	$db_fn = $row_delete['eName'];
}

echo "<h1>Are you sure you want to delete $db_fn? </h1>";
...
<form method="POST" action="delete_now.php">
	...
	<br>
	<input type="submit" name="yes" value="YES"> &nbsp; <a href="payroll.php">NO</a>
</form>
